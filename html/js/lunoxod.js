...
var _user$project$Lunomodel$addCosmonaut = F2(
	function (ship, cosmonaut) {
		return _elm_lang$core$Native_Utils.update(
			ship,
			{
				persons: {ctor: '::', _0: cosmonaut, _1: ship.persons}
			});
	});
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Время полета'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Топливо'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Высота'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Скорость'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										},
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(' м/с'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('col s12 offset-s6'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
					...
					return A2(
						...
						function (weight) {
							return _elm_lang$core$Json_Decode$succeed(
								{fuel: fuel, maxAcc: maxAcc, weight: weight});
						},
						A2(_elm_lang$core$Json_Decode$field, 'weight', _elm_lang$core$Json_Decode$float));
				},
				A2(_elm_lang$core$Json_Decode$field, 'maxAcc', _elm_lang$core$Json_Decode$float));
		},
		A2(_elm_lang$core$Json_Decode$field, 'fuel', _elm_lang$core$Json_Decode$float)));
...
var _user$project$Lunoxod$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Lunoxod$startGame(_user$project$Lunoxod$StartGame),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Lunoxod$Tick),
				_1: {ctor: '[]'}
			}
		});
};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('col s2 chip'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Реверс тяги'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col s10'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Выкл.'),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$checked(model.engine.revers),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html_Events$on,
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html$text('Вкл.'),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Lunoxod$massEngineView = function (model) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('row valign-wrapper'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('col s2 valign chip'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Расход: '),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$b,
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('col s10 valign'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('col s1 valign'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('btn-floating'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Lunoxod$DecFuel),
													_1: {ctor: '[]'}
												}
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('fast_rewind'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('col s8 valign'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('range-field'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$a,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$Lunoxod$IncFuel),
																	_1: {ctor: '[]'}
																}
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('fast_forward'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}),
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Lunoxod$Start),
							_1: {
								ctor: '::',
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('ПУСК'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('За время: '),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$b,
							...
							},
							{
									...
									},
									{
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Lunoxod$DecTime),
													_1: {ctor: '[]'}
												}
											},
											{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('0.7'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$input,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$min('0.7'),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$max('60'),
																		_1: {
																			ctor: '::',
													...
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$a,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$Lunoxod$IncTime),
																	_1: {ctor: '[]'}
																}
															},
															{
...
var _user$project$Lunoxod$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Lunoxod$infoView(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
					...
					{
						ctor: '::',
						_0: _user$project$Lunoxod$massEngineView(model),
						_1: {
							ctor: '::',
							_0: _user$project$Lunoxod$timeEngineView(model),
							_1: {
								ctor: '::',
								_0: _user$project$Lunoxod$reversEngineView(model),
								_1: {
									ctor: '::',
									_0: _user$project$Lunoxod$startEngineView(model),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Lunoxod$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'IncFuel':
				var fuelMax = (_elm_lang$core$Native_Utils.cmp(model.ship.fuel, 100) > 0) ? 100 : model.ship.fuel;
				var newEngine = (_elm_lang$core$Native_Utils.cmp(model.engine.mass + 1, fuelMax) > 0) ? _elm_lang$core$Native_Utils.update(
					oEngine,
					{mass: fuelMax}) : _elm_lang$core$Native_Utils.update(
					oEngine,
					{mass: model.engine.mass + 1});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'DecFuel':
				var newEngine = (_elm_lang$core$Native_Utils.cmp(model.engine.mass - 1, 0) < 0) ? _elm_lang$core$Native_Utils.update(
					oEngine,
					{mass: 0}) : _elm_lang$core$Native_Utils.update(
					oEngine,
					{mass: model.engine.mass - 1});
				return {
					ctor: '_Tuple2',
			...
			case 'IncTime':
				var newEngine = (_elm_lang$core$Native_Utils.cmp(model.engine.time + 1, 60) > 0) ? _elm_lang$core$Native_Utils.update(
					oEngine,
					{time: 100}) : _elm_lang$core$Native_Utils.update(
					oEngine,
					{time: oEngine.time + 1});
				return {
					ctor: '_Tuple2',
			...
			case 'DecTime':
				var newEngine = (_elm_lang$core$Native_Utils.cmp(model.engine.time - 1, 0.7) < 0) ? _elm_lang$core$Native_Utils.update(
					oEngine,
					{time: 0.7}) : _elm_lang$core$Native_Utils.update(
					oEngine,
					{time: model.engine.time - 1});
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ChangeRevers':
				var newEngine = model.engine.revers ? _elm_lang$core$Native_Utils.update(
					oEngine,
					{revers: false}) : _elm_lang$core$Native_Utils.update(
					oEngine,
					{revers: true});
				return {
					ctor: '_Tuple2',
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{started: true, engine: newEngine}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Lunoxod$main = _elm_lang$html$Html$program(
...
if (typeof _user$project$Lunoxod$main !== 'undefined') {
    _user$project$Lunoxod$main(Elm['Lunoxod'], 'Lunoxod', undefined);
}
